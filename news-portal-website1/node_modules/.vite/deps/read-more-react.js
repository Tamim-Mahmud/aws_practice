...
// node_modules/read-more-react/dist/utils/trimText.js
var require_trimText = __commonJS({
  "node_modules/read-more-react/dist/utils/trimText.js"(exports) {
    "use strict";
    ...
    var trimText = function trimText2(text) {
      var min = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 80;
      var ideal = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 100;
      var max = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 200;
      ...
      var setSpace = function setSpace2(idx) {
    ...
    var spaceMatch = function spaceMatch2(character) {
      if (character === " ") {
        return true;
      }
    };
    var punctuationMatch = function punctuationMatch2(idx, text) {
      var punctuationIdx = PUNCTUATION_LIST.indexOf(text[idx]);
      if (punctuationIdx >= 0 && spaceMatch(text[idx + 1])) {
        return true;
      }
    };
    var checkMatch = function checkMatch2(idx, text, max, min) {
...
// node_modules/read-more-react/dist/components/ReadMoreReact.js
var require_ReadMoreReact = __commonJS({
  "node_modules/read-more-react/dist/components/ReadMoreReact.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _trimText3 = _interopRequireDefault(require_trimText());
    ...
    var ReadMoreReact = function(_React$Component) {
      _inherits(ReadMoreReact2, _React$Component);
      function ReadMoreReact2(props) {
        var _this;
        _classCallCheck(this, ReadMoreReact2);
        _this = _possibleConstructorReturn(this, _getPrototypeOf(ReadMoreReact2).call(this, props));
        var args = [_this.props.text, _this.props.min, _this.props.ideal, _this.props.max];
        var _trimText = _trimText3["default"].apply(void 0, args), _trimText2 = _slicedToArray(_trimText, 2), primaryText = _trimText2[0], secondaryText = _trimText2[1];
        _this.state = {
...
// node_modules/read-more-react/dist/index.js
var require_dist = __commonJS({
  "node_modules/read-more-react/dist/index.js"(exports, module) {
    module.exports = require_ReadMoreReact();
  }
});
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=read-more-react.js.map
